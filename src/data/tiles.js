  ...
  },
  {
    ...
    screens: [
      ...
      { slug: 'what-happens-at-a-fitting', title: 'What happens at a fitting', subtitle: 'Step by step, no surprises.' },
      {
        ...
        title: 'Living flat vs. prosthetics',
        subtitle: 'Tools, not obligations.',
        body: [
          { type: 'p', text: 'Some women living flat choose never to use prosthetics, and that\'s just as valid as choosing them. If and when you want to explore options, here\'s a simple overview of Amoena\'s range to start the conversation — a proper fitting will always be the next step.' },
          { type: 'table', headers: ['Type', 'When it\'s useful', 'Possible downside'], rows: [
            ['Priform (textile, transitional)', 'Immediately post-op and through the first weeks of healing, while scars are still tender', 'Less defined shape under fitted clothes; meant to be temporary'],
            ['Essential / Natura (silicone)', 'Everyday office and casual wear, once healing allows', 'Weight and warmth for some women'],
            ['Adapt Air (adjustable air-chamber)', 'If volume needs change day to day, or fit needs fine-tuning without a refit', 'May cost more; still a silicone form, same weight considerations apply'],
            ['Natura Xtra Light', 'If shoulders or neck ache under a standard silicone form\'s weight', 'Slightly less natural movement than a standard-weight form, by design trade-off'],
            ['Contact (self-adhesive)', 'If she wants a "fixed" feel under clothes, less bra-dependent', 'Still generally recommended to be worn with a bra rather than instead of one; skin contact might be too much on healing or sensitive skin'],
            ['Aqua Wave (swim/active)', 'Swimming, beach, pool, active wear', 'Extra purchase just for water; not a substitute for an everyday form'],
          ] },
          { type: 'quote', text: 'Whatever you choose — or don\'t — it\'s your call to make, not anyone else\'s.' },
        ],
      },
      {
    ...
    screens: [
      {
        ...
        body: [
          { type: 'p', text: 'You don\'t owe anyone your medical history. These aren\'t speeches — they\'re doors. Use the size of door the situation actually needs, then close it.' },
          { type: 'heading', text: 'For your boss, about the return itself' },
          { type: 'quote', text: 'I\'ve had major chest surgery and need a phased return: [x] days a week to start, remote options where possible, and breaks built into the day, not squeezed around it.' },
          { type: 'p', text: 'Say it once, calmly, like a logistics update — because that\'s what it is. If they push for more detail than you want to give, "that\'s the medical advice I\'m working with" closes it without an argument.' },
          { type: 'heading', text: 'For a colleague who means well but asks too much' },
          { type: 'quote', text: 'I\'m doing okay, thanks for asking — I\'d rather talk about anything else today.' },
          { type: 'p', text: 'Said with a smile, it ends the topic without ending the friendliness. Most people take the redirect gladly; they didn\'t actually want a detailed answer, they wanted to show they cared.' },
          { type: 'p', text: 'If someone keeps going after that: "I\'ll let you know if I want to talk about it" is a full stop, not rude. You\'re allowed to use it.' },
          { type: 'heading', text: 'For the colleague who comments on how you look' },
          { type: 'quote', text: 'Different, but I\'m getting used to it — how\'s your week going?' },
          { type: 'p', text: 'Acknowledges the comment exists, declines to make it a conversation, moves the floor back to them. You don\'t have to manage their discomfort about your body on top of your own.' },
          { type: 'heading', text: 'For someone who asks directly what happened' },
          { type: 'p', text: 'Pick whichever altitude suits the room: "Preventive surgery — all good," or "I had a double mastectomy," and stop there if you want to. Neither needs justifying with statistics or reasons. A full sentence is a complete answer; it doesn\'t owe a follow-up.' },
          { type: 'heading', text: 'For a stranger or acquaintance who\'s just being nosy' },
          { type: 'quote', text: 'That\'s a bit personal for here.' },
          { type: 'p', text: 'Delivered flat, not apologetic. You\'re not the one being rude in that exchange.' },
          { type: 'heading', text: 'The rule under all of these' },
          { type: 'p', text: 'Shorter is armour. The more words you give a question you didn\'t want, the more doors you open that you then have to manage. A short, warm, closed answer is not cold — it\'s just correctly sized.' },
        ],
      },
